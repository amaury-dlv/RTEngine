/*
** Mesh.h for Mesh in /afs/epitech.net/users/epitech_2015/patard_a/rendu/c/Raytracer/RTEngine/Mesh
** 
** Made by amaury patard-de-la-vieuville
** Login   <patard_a@epitech.net>
** 
** Started on  Fri May 13 15:26:47 2011 amaury patard-de-la-vieuville
** Last update Fri May 13 15:26:47 2011 amaury patard-de-la-vieuville
*/
/*
...
* was changed to always open files in binary mode, files written in ascii
* can also be
...
* was changed to handle line breaks in UNIX, MACINTOSH, PC, it resets the
* file pointer
...
operating system dependent, as a line break in unix is indicated with the
escape character \n,
on a macintosh, with \r, and on a pc with \r\n  <--2 unsigned chars, 2 bytes,
instead of 1 byte.

get_words allows reading of any OS, text editors such as BBEdit do not save
the linebreaks
...
extern PlyProperty **ply_get_element_description(PlyFile *, char *,
    int*, int*);
